...
var $ = __webpack_require__("79c6");
var toInteger = __webpack_require__("4df2");
var thisNumberValue = __webpack_require__("7cf2");
var repeat = __webpack_require__("d1f6");
var fails = __webpack_require__("fa79");
...
// EXTERNAL MODULE: ./src/components/vue-luck-draw/node_modules/core-js/modules/es.number.to-fixed.js
var es_number_to_fixed = __webpack_require__("a81e");
...
// CONCATENATED MODULE: ./src/components/vue-luck-draw/utils/math.js
...
var math_drawRadian = function drawRadian(ctx, r, start, end) {
  ...
  var _getArcPointerByDeg = getArcPointerByDeg(start, r),
      _getArcPointerByDeg2 = _slicedToArray(_getArcPointerByDeg, 2),
      x1 = _getArcPointerByDeg2[0],
      y1 = _getArcPointerByDeg2[1];

  var _getArcPointerByDeg3 = getArcPointerByDeg(end, r),
      _getArcPointerByDeg4 = _slicedToArray(_getArcPointerByDeg3, 2),
      x2 = _getArcPointerByDeg4[0],
      y2 = _getArcPointerByDeg4[1];

  var _getTangentByPointer = getTangentByPointer(x1, y1),
      _getTangentByPointer2 = _slicedToArray(_getTangentByPointer, 2),
      k1 = _getTangentByPointer2[0],
      b1 = _getTangentByPointer2[1];

  var _getTangentByPointer3 = getTangentByPointer(x2, y2),
      _getTangentByPointer4 = _slicedToArray(_getTangentByPointer3, 2),
      k2 = _getTangentByPointer4[0],
      b2 = _getTangentByPointer4[1];
...
var drawRoundRect = function drawRoundRect(ctx, x, y, w, h, r, color) {
...
var math_getLinearGradient = function getLinearGradient(ctx, x, y, w, h, background) {
  ...
  methods: {
    ...
    draw: function draw() {
      ...
      this.blockData.forEach(function (_ref2) {
        ...
        drawRoundRect(ctx, x, y, w, h, r, _this5.handleBackground(x, y, w, h, background));
      }); // 绘制所有格子
    ...
    handleBackground: function handleBackground(x, y, width, height, background) {
      ...
      if (background.includes('linear-gradient')) {
        background = math_getLinearGradient(ctx, x, y, width, height, background);
      }
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"421849a9-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/vue-luck-draw/src/LuckyWheel.vue?vue&type=template&id=8dbffac2&
var LuckyWheelvue_type_template_id_8dbffac2_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{ref:"luckDraw",staticStyle:{"overflow":"hidden"}},[_c('canvas')])}
var LuckyWheelvue_type_template_id_8dbffac2_staticRenderFns = []


// CONCATENATED MODULE: ./src/components/vue-luck-draw/src/LuckyWheel.vue?vue&type=template&id=8dbffac2&
...
var LuckyWheel_component = normalizeComponent(
  ...
  LuckyWheelvue_type_template_id_8dbffac2_render,
  LuckyWheelvue_type_template_id_8dbffac2_staticRenderFns,
  false,
  null,
  null,
  null
